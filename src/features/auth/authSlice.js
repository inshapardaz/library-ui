...
export const forgetPassword = createAsyncThunk(
  ...
  async ({ email }) => {
    try {
      const response = await axiosPublic.post("/accounts/forgot-password", {
        email,
      });
      return response.data;
    } catch (err) {
...
export const registerPassword = createAsyncThunk(
  ...
  async ({ code, name, password, acceptTerms }) => {
    try {
      const response = await axiosPublic.post(`/accounts/register/${code}`, {
        name,
        password,
        acceptTerms,
      });
...
export const resetPassword = createAsyncThunk(
  ...
  async ({ code, password, confirmPassword }) => {
    try {
      const response = await axiosPublic.post("/accounts/reset-password", {
        token: code,
        password,
        confirmPassword,
      });
...
export const changePassword = createAsyncThunk(
  ...
  async ({ oldPassword, password }) => {
    try {
      const response = await axiosPrivate.post("/accounts/change-password", {
        password,
        oldPassword,
      });
      return response.data;
