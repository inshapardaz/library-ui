...
export const IconAnnually = (props) => getIcon('annually', props)
export const IconQuarterly = (props) => getIcon("quarterly", props)
export const IconMonthly = (props) => getIcon('monthly', props)
export const IconFornightly = (props) => getIcon("fornightly", props)
export const IconWeekly = (props) => getIcon("weekly", props)
export const IconDaily = (props) => getIcon("daily", props)
export const IconIssue = (props) => getIcon("issue", props)
export const IconIssueArticle = (props) => getIcon("issueArticle", props)
export const IconVolumeNumber = (props) => getIcon("volumeNumber", props)
export const IconIssueNumber = (props) => getIcon("issueNumber", props)
//-----------------------------------------------------
// Old Icons
